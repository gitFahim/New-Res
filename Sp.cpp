...
int findKnn(int k) {
    ...
    //cout << "Class-wise nearest neighbors: " << endl;
    for (int i=0; i<10; i++) {
...
int main() {
    ...
    int test_samples[10] = {100021, 101021, 102021, 103021, 104021, 105021, 106021, 107021, 108021, 109021};
    for(int i=0; i<10; i++){

        int output_nb = predictUsingNB(test_samples[i]);
        cout << "Naive Bayes Output: " << output_nb << endl;
        int output_knn = predictUsingKNN(test_samples[i], 10);
        cout << "K(10)-NN Output: " << output_knn << endl;
        cout << "-----o-----o-----" << endl;
